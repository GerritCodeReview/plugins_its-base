...
public class SinceLastTagCommitCollector implements CommitCollector {
  ...
  @Override
  public List<String> collect(Set<Property> properties) throws IOException {
    String projectName = PropertyUtils.getValue(properties, "project");
    String ref = PropertyUtils.getValue(properties, "ref");
    String revision = PropertyUtils.getValue(properties, "revision");
