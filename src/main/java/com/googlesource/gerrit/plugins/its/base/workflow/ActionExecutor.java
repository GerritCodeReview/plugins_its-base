...
public class ActionExecutor {
  ...
  private final DynamicMap<SpecificAction> specificActions;
  ...
  public ActionExecutor(
      ...
      DynamicMap<SpecificAction> specificActions) {
  ...
  private Action getAction(String actionName) {
    switch (actionName) {
      ...
      default:
        return specificActions.get(PluginName.GERRIT, actionName);
    }
  }
  ...
  private void execute(
    ...
    if (action instanceof StandardAction) {
      ...
      SpecificAction specificAction = (SpecificAction) action;
      specificAction.execute(target, actionRequest, properties);
    } else {
