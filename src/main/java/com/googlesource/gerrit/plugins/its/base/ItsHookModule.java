...
import com.googlesource.gerrit.plugins.its.base.workflow.KeyedEventExecutor;
...
public class ItsHookModule extends FactoryModule {
  ...
  protected void configure() {
    ...
    bind(EventExecutor.class).to(KeyedEventExecutor.class);
    DynamicSet.bind(binder(), LifecycleListener.class).to(KeyedEventExecutor.class);
