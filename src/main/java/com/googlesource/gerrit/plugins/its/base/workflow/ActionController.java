...
import com.googlesource.gerrit.plugins.its.base.Execution;
...
public class ActionController implements EventListener {
  ...
  private final BoundedOrderedExecutor executionExecutor;
  ...
  public ActionController(
      ...
      ItsConfig itsConfig,
      @Execution BoundedOrderedExecutor executionExecutor) {
    ...
    EventHandler(RefEvent refEvent) {
      ...
      try {
        ...
        if (!actionRunnables.isEmpty()) {
          executionExecutor.execute(ChangeKey.from(refEvent), this);
        }
      } finally {
