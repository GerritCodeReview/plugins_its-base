...
public class ActionController implements EventListener {
  ...
  private final BoundedOrderedExecutor boundedOrderedExecutor;
  ...
  public ActionController(
      ...
      ItsConfig itsConfig,
      BoundedOrderedExecutor boundedOrderedExecutor) {
    this.propertyExtractor = propertyExtractor;
    this.ruleBase = ruleBase;
    this.actionExecutor = actionExecutor;
    this.itsConfig = itsConfig;
    this.boundedOrderedExecutor = boundedOrderedExecutor;
  }
    ...
    EventHandler(RefEvent refEvent) {
      ...
      try {
        ...
        if (!actionRunnables.isEmpty()) {
          boundedOrderedExecutor.execute(ChangeKey.from(refEvent), this);
        }
      } finally {
