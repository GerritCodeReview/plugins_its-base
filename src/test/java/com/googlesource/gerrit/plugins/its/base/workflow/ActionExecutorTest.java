...
public class ActionExecutorTest extends LoggingMockingTestCase {
  ...
  public void testExecuteItemException() throws IOException {
    ...
    doThrow(new IOException("injected exception 1")).when(its).performAction("4711", "unparsed action 1");
  ...
  public void testExecuteIterable() throws IOException {
    ...
    when(itsFacadeFactory.getFacade(Project.nameKey(properties.get("project"))))
        .thenReturn(its);
  ...
  public void testExecuteIterableExceptions() throws IOException {
    ...
    doThrow(new IOException("injected exception 1")).when(its).performAction("4711", "unparsed action 1");
    doThrow(new IOException("injected exception 3")).when(its).performAction("4711", "unparsed action 3");
  ...
  public void testCreateVersionFromPropertyDelegation() throws IOException {
    ...
    CreateVersionFromProperty createVersionFromProperty =
        mock(CreateVersionFromProperty.class);
    ...
    verify(createVersionFromProperty).execute(its, "itsTestProject", actionRequest, projectProperties);
  }
