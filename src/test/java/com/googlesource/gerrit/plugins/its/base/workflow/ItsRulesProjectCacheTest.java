...
public class ItsRulesProjectCacheTest extends LoggingMockingTestCase {
  ...
  public void testProjectConfigIsLoaded() throws IOException {
    ...
    ItsRulesProjectCache.Loader loader = injector.getInstance(ItsRulesProjectCache.Loader.class);
    Collection<Rule> actual = loader.load(new Project.NameKey(TEST_PROJECT));
