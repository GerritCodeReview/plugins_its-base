...
public class MarkPropertyAsReleasedVersionTest extends MockingTestCase {
  ...
  private class TestModule extends FactoryModule {
    ...
    protected void configure() {
      ...
      parametersExtractor = createMock(MarkPropertyAsReleasedVersionParametersExtractor.class);
      bind(MarkPropertyAsReleasedVersionParametersExtractor.class).toInstance(parametersExtractor);
    }
  }

  public void testHappyPath() throws IOException {
    MarkPropertyAsReleasedVersionParameters extractedParameters =
        createMock(MarkPropertyAsReleasedVersionParameters.class);
    expect(extractedParameters.getPropertyValue()).andReturn(PROPERTY_VALUE);
    ...
    expect(parametersExtractor.extract(actionRequest, properties))
        .andReturn(Optional.of(extractedParameters));
