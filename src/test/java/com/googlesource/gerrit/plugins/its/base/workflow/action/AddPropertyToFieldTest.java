 ...
 */
public class AddPropertyToFieldTest extends LoggingMockingTestCase {
  ...
  public void testOneParameter() throws IOException {
    testWrongNumberOfReceivedParameters(new String[] {FIELD_ID});
  }

  public void testThreeParameters() throws IOException {
    testWrongNumberOfReceivedParameters(new String[] {FIELD_ID, FIELD_ID, FIELD_ID});
  }
  ...
  public void testBlankFieldId() throws IOException {
    ...
    assertLogMessageContains("Received field id is blank", Level.ERROR);
  }
  ...
  public void testBlankPropertyId() throws IOException {
    ...
    assertLogMessageContains("Received property id is blank", Level.ERROR);
  }
  ...
  public void testUnknownPropertyId() throws IOException {
    ...
    assertLogMessageContains("No event property found", Level.ERROR);
  }
  ...
  public void testHappyPath() throws IOException {
    ...
    its.addValueToField(ISSUE_ID, FIELD_ID, PROPERTY_VALUE);
  ...
  private void testWrongNumberOfReceivedParameters(String[] parameters) throws IOException {
    ...
    assertLogMessageContains("Wrong number of received parameters", Level.ERROR);
  }
