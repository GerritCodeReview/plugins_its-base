...
public class FireEventOnCommitsParametersExtractorTest extends MockingTestCase {
  ...
  public void testUnknownCollectorName() {
    ActionRequest actionRequest = createMock(ActionRequest.class);
    expect(actionRequest.getParameters()).andReturn(new String[] {"foo"});
  ...
  public void testSinceLastTagCollector() {
    ActionRequest actionRequest = createMock(ActionRequest.class);
    expect(actionRequest.getParameters()).andReturn(new String[] {SINCE_LAST_TAG_COLLECTOR});
