...
@PrepareForTest({TroubleClient.class, Config.class, ByteArrayInputStream.class})
public class TroubleClientTest {
  ...
  public void setUp() {
    // Prepare config mock
    doReturn("").when(configMock).getString(TroubleItsFacade.ITS_NAME_TROUBLE, null, "url");
    doReturn("").when(configMock).getString(TroubleItsFacade.ITS_NAME_TROUBLE, null, "username");
    doReturn("").when(configMock).getString(TroubleItsFacade.ITS_NAME_TROUBLE, null, "password");
  }
  ...
  public void testGetTicket() throws Exception {
    ...
    TroubleClient client = TroubleClient.create(configMock, TEST_TICKET_ID);
